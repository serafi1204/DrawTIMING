...
class Line:
    ...
    def style(self, color="RGB(0,0,0)", lineType=0):
        self.visioObject.CellsSRC(Visio.constants.visSectionObject, Visio.constants.visRowLine, Visio.constants.visLinePattern).FormulaU = f"{lineType}"
        self.visioObject.CellsSRC(Visio.constants.visSectionObject, Visio.constants.visRowLine, Visio.constants.visLineColor).FormulaU = f"THEMEGUARD({color})"
